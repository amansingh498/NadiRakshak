...
def seed_database():
    ...
    # 1. Rivers
    # Yamuna Delhi Pilot stretch coordinates (Wazirabad to Okhla Barrage)
    yamuna_coords = [
    ...
    # Ganga Varanasi Pilot stretch coordinates
    ganga_coords = [
    ...
    stations_data = [
        # Yamuna stations (progressing from cleaner upstream to polluted downstream)
    ...
    # 3. Water Quality Measurements (Realistic profiles reflecting CPCB published reports)
    # Wazirabad: Moderate/Fair (before drains)
    # ITO / Kalindi: Critical / Poor (heavy organic load from Najafgarh & Shahdara drains)
    station_profiles = {
    ...
    for st in station_objs:
        ...
        # Add historical measurements for last 4 months
        for i in range(4):
    ...
    # 4. Realistic Citizen Incident Reports across various lifecycle states
    demo_incidents = [
        {
            "river_id": yamuna.id,
            "track": "R-2026-10492",
